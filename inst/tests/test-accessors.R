...
min_sparse_hdf5 = system.file("extdata","min_sparse_otu_table_hdf5.biom",package="biom")
rich_sparse_hdf5 = system.file("extdata","rich_sparse_otu_table_hdf5.biom",package="biom")
